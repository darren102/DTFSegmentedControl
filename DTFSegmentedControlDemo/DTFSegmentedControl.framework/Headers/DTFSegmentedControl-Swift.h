...
SWIFT_CLASS("_TtC19DTFSegmentedControl23DTFSegmentedControlView")
@interface DTFSegmentedControlView : UICollectionView
@property (nonatomic) double cellWidth;
@property (nonatomic, copy) void (^ __nonnull selectedFunc)(NSString * __nonnull, NSIndexPath * __nonnull);
...
- (void)configureControl:(NSArray * __nonnull)titles data:(NSArray * __nonnull)data;
@end


@interface DTFSegmentedControlView (SWIFT_EXTENSION(DTFSegmentedControl)) <UICollectionViewDelegate>
...
@interface DTFSegmentedControlView (SWIFT_EXTENSION(DTFSegmentedControl)) <UICollectionViewDataSource>
